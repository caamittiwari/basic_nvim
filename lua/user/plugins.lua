...
-- Icon
  ...
  use {
    ...
    commit = 'be655cc7ce0f5d6d24eeaf8b36e82693fd2facca', wants = {'nvim-treesitter'} } -- or require if not used so far
  ...
  -- java
  use ({"mfussenegger/nvim-jdtls", commit =" f35efb60a0ba208ff2de063085d8b5603e536f9e"})
